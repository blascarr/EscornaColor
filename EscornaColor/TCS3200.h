...
#define _TCS3200_H
	...
	*/
	...
	#if SENDCOLOR == 1 && defined(SERIAL_DEBUG)
		#define  DUMPCOLOR(code) { SERIALDEBUG.print(COLOR_STARTCMD); SERIALDEBUG.print(code);SERIALDEBUG.print(COLOR_ENDCMD);}
	#elif SENDCOLOR == 0
		#define  DUMPCOLOR(code) { }
	#endif
	...
	class TCS3200 {
		public:
			...
			TCS3200();
			TCS3200(uint8_t S2, uint8_t S3, uint8_t OUT );
			...
			//  Data handling
			void  setPins(uint8_t S2, uint8_t S3, uint8_t OUT ){ _S2 = S2; _S3 = S3; _OUT = OUT; };
			void  setPins(uint8_t S2, uint8_t S3, uint8_t OUT, uint8_t LED ){ _S2 = S2; _S3 = S3; _OUT = OUT; _LED = LED; };
			void  setPins(uint8_t S2, uint8_t S3, uint8_t OUT, uint8_t S0, uint8_t S1,uint8_t LED ){ _S2 = S2; _S3 = S3; _OUT = OUT; _LED = LED; _S0 = S0; _S1 = S1; };
	...
	TCS3200::TCS3200(uint8_t S2, uint8_t S3, uint8_t OUT ){
		_S2 = S2;
		_S3 = S3;
		_OUT = OUT;
		_freqSet = TCS3200_FREQ_HI;
